 ...
 * @author tokumitsu
 */
public class UniformRepairDynamicEnvironment extends UniformRepairSelfRepairNetworkModel {

    public UniformRepairDynamicEnvironment(String[] args) {
        super(args);

//        try {
//            System.setOut(new PrintStream("uniform_repair_in_dynamic_environment.log"));
//        } catch(Exception e) {
//            e.printStackTrace();;
//        }
    }
