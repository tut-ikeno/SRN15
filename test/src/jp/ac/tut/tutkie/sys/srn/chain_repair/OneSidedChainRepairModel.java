 ...
 * @author tokumitsu
 */
public class OneSidedChainRepairModel extends SelfRepairNetworkModel {
    ...
    public OneSidedChainRepairModel(String[] args) {
        super(args);
...
//        System.out.println("");
    ...
    private void assignPointToUnits() {
        ...
        for (Agent agent : agentList) {
            ...
            List<Agent> neighborAgentList = unit.getNeighborUnitList();

            List<Agent> targetNeighborAgentList = ((ChainRepairUnit) unit).getTargetNeighborUnitList();
            targetNeighborAgentList.addAll(neighborAgentList);
        }
    }
